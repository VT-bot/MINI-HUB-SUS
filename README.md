...
local Paragraph = VisualTab:CreateParagraph({Title = "MINI HUB", Content = "feito por AMIR & SACOLA"})
...
local Paragraph = TeleportTab:CreateParagraph({Title = "MINI HUB", Content = "feito por SACOLA"})
...
local Paragraph = rev:CreateParagraph({Title = "MINI HUB", Content = "feito por amir & sacola"})
...
local Paragraph = otoTab:CreateParagraph({Title = "MINI HUB", Content = "feito por amir & sacola"})
